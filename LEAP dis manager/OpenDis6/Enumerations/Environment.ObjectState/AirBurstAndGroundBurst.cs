...
namespace OpenDis.Enumerations.Environment.ObjectState
{
    ...
    public struct AirBurstAndGroundBurst : IHashable<AirBurstAndGroundBurst>
    {
        ...
        public static AirBurstAndGroundBurst FromByteArray(byte[] array, int index) => array == null
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => obj is AirBurstAndGroundBurst other && Equals(other);
