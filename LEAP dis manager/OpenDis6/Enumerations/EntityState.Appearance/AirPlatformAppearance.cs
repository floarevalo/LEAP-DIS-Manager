...
namespace OpenDis.Enumerations.EntityState.Appearance
{
    ...
    public struct AirPlatformAppearance : IHashable<AirPlatformAppearance>
    {
        ...
        public static AirPlatformAppearance FromByteArray(byte[] array, int index) => array == null
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => obj is AirPlatformAppearance other && Equals(other);
